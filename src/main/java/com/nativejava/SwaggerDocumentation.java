...
public class SwaggerDocumentation {
	...
	public static final Contact CONTACT = new Contact("Murali", "http://nativejava.blogspot.com/",
			"muralidharan.rade@gmail.com");
	public static final ApiInfo DEFAULT_API = new ApiInfo("cloud-starter", "Cloud Native REST APIs", "1.0", "urn:tos",
